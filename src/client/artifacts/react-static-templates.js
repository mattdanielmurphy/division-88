...
'../src/pages/artist.js': require('../src/pages/artist.js').default,
'../src/pages/artists.js': require('../src/pages/artists.js').default,
'../src/pages/blog.js': require('../src/pages/blog.js').default,
'../src/pages/index.js': require('../src/pages/index.js').default,
'../src/pages/producer-tools.js': require('../src/pages/producer-tools.js').default,
