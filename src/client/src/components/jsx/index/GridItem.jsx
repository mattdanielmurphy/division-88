...
class GridItemContent extends React.Component {
  ...
  backgroundTextHasText = () =>
    this.props.backgroundText.heading || this.props.backgroundText.subheading
  state = {
    style: {
  ...
  render = () => {
    return (
      ...
      >
        <div
          className={`background ${this.props.selected ? 'selected' : ''}`}
          style={this.state.style}
        />
        {this.props.backgroundText && this.backgroundTextHasText() && (
          <BackgroundText
