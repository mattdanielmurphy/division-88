  ...
  render = () => (
    <div className='non-video-options'>
        ...
        <input
          ...
          value={
            this.props.state.cell.backgroundText
              ? this.props.state.cell.backgroundText.heading || ''
              : ''
          }
        />
      </div>
      ...
      <div className='property-input'>
        ...
        <ColorPicker
          color={
            (this.props.state.cell.bottomText &&
              this.props.state.cell.bottomText.backgroundColor) ||
            '#fff'
          }
          setColor={(color) => {
      ...
      <div className='property-input'>
        ...
        <input
          ...
          value={
            this.props.state.cell.bottomText
              ? this.props.state.cell.bottomText.height || ''
              : ''
          }
        />
      </div>
      <div className='property-input'>
        ...
        <input
          ...
          value={
            this.props.state.cell.bottomText
              ? this.props.state.cell.bottomText.text || ''
              : ''
          }
        />
      </div>
